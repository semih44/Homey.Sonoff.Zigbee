...
class DetachBoundCluster extends BoundCluster {
    constructor(node, channel) {
        ...
        this._click = node.homey.flow.getDeviceTriggerCard(`SonoffZBM52C80:toggle_l${channel}`);
    }
    toggle() {
...
class SonoffZBM52C80 extends SonoffBase {
    ...
    async onDeleted() {
        this.log('ZBM5-2C-80/86 removed');
        await super.onDeleted();
    }
}

module.exports = SonoffZBM52C80;
