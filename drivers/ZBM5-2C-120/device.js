...
class DetachBoundCluster extends BoundCluster {
    constructor(node, channel) {
        ...
        this._click = node.homey.flow.getDeviceTriggerCard(`SonoffZBM52C120:toggle_l${channel}`);
    }
    toggle() {
...
class SonoffZBM52C120 extends SonoffBase {
    ...
    async onDeleted() {
        this.log('ZBM5-2C-120 removed');
        await super.onDeleted();
    }
}

module.exports = SonoffZBM52C120;
