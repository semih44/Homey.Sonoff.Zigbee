...
class DetachBoundCluster extends BoundCluster {
    constructor(node, channel) {
        ...
        this._click = node.homey.flow.getDeviceTriggerCard(`SonoffZBM53C80:toggle_l${channel}`);
    }
    toggle() {
...
class SonoffZBM53C80 extends SonoffBase {
    ...
    async onDeleted() {
        this.log('ZBM5-3C-80/86 removed');
        await super.onDeleted();
    }
}

module.exports = SonoffZBM53C80;
