...
class SonoffSWVZNU extends SonoffBase {
    ...
    _updateAlarmState(value) {
        // SWV-ZNU: bit0=water_shortage, bit1=water_leakage, bit2=frost, bit3=fail_safe
